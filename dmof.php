...
function dmof_admin_enqueues(){
	...
	wp_enqueue_style( 'dmof-styles', DMOF_framework_URL . 'DMOF/assets/css/styles.css', array( 'wp-color-picker' ), '1.0.0', 'all');
	/* Load Theme Script */
	...
	wp_register_script( 'alpha-color-picker', DMOF_framework_URL . 'DMOF/assets/js/alpha-color-picker.js', array('wp-color-picker'),'', true );
	wp_enqueue_script( 'alpha-color-picker' );

	wp_register_script( 'select2_min_js', 'https://cdnjs.cloudflare.com/ajax/libs/select2/4.0.3/js/select2.min.js','','',true );
	wp_enqueue_script( 'select2_min_js' );

	wp_register_script( 'dmof-jquery', DMOF_framework_URL . 'DMOF/assets/js/jquery.js',array('jquery'),'',true );
