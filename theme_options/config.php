...
function add_dmof_options_callback() {
	...
	$options[] = array(
		...
		'fields'	=> array(
			...
			// Select Login Page
			array(
				'id'			=> 'opt_select_login_page',
				'type'			=> 'select',
				'title'			=> __('Select Login Page','dmof'),
				'subtitle'		=> __('select page for login','dmof'),
				'desc'			=> __('Which login page you select here apply for all login page link','dmof'),
				'data_type'		=> 'pages',
				'default'		=> '10',
			),
			// Select Register Page
			array(
				'id'			=> 'opt_select_register_page',
				'type'			=> 'select',
				'title'			=> __('Select Register Page','dmof'),
				'subtitle'		=> __('select page for Register','dmof'),
				'desc'			=> __('Which login page you select here apply for all register page link','dmof'),
				'data_type'		=> 'pages',
				'default'		=> '12',
			),
		),
	...
	$options[] = array(
		...
		'fields'	=> array(
			...
			array(
				'id'			=> 'opt_footer_logo_text',
				'type'			=> 'textarea',
				'title'			=> __('Footer Text','dmof'),
				'subtitle'		=> __('Enter your footer text','dmof'),
				//'desc'			=> __('Description','dmof'),
	...
	// API Key for site Section
	$options[] = array(
		'id'		=> 'section-api-key-start',
		'title'		=> 'API Settings',
		...
		'fields'	=> array(
			...
			// Google APi
			array(
				'id'			=> 'opt-section-google-api-start',
				'type'			=> 'section',
				'title'			=> __('Google API Key','dmof'),
				'position'		=> 'start',
			),

				// Google Map API key
				array(
					'id'			=> 'opt_google_map_api_key',
					'type'			=> 'text',
					'title'			=> __('Google Map API Key','dmof'),
					'subtitle'		=> __('Enter the google map api key','dmof'),
					'default'		=> 'google map',
				),

				// Google Recaptcha key
				array(
					'id'			=> 'opt_google_recaptcha_api_key',
					'type'			=> 'text',
					'title'			=> __('Google Recaptcha API Key','dmof'),
					'subtitle'		=> __('Enter the google recaptcha api key','dmof'),
					'default'		=> 'google recaptcha',
				),

			array(
				'id'			=> 'opt-section-google-api-end',
				'type'			=> 'section',
				'position'		=> 'end',
			),
			...
			// Facebook APi
			array(
				'id'			=> 'opt-section-facebook-api-start',
				'type'			=> 'section',
				'title'			=> __('Facebook API Key','dmof'),
				'position'		=> 'start',
			),
				...
				array(
					...
					'type'			=> 'text',
					'title'			=> __('Facebook API Key','dmof'),
					'subtitle'		=> __('Enter the facebook api key','dmof'),
					'default'		=> 'Facebook Api',
				),

			array(
				'id'			=> 'opt-section-facebook-api-end',
				'type'			=> 'section',
				'position'		=> 'end',
			),
		),
