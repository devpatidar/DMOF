										...
										<table class="widefat striped form-table">
											<tbody>	
												<?php foreach ($fields as $key => $field) {
													...
													$get_value = dmof_theme_options( $id );
													...
													if ($required) {
														if (is_array($required)) {
															...
															// $required_val = dmof_theme_options( $req_id );
															...
															$required_val = dmof_theme_options( $required );
															if ($required_val == 0) {
																$style_attr = 'style="display:none;"';
															}
														}
									...
									<tr class="dmof_options_fields">
										...
										<td class="dmof_content">
											...
											<div class="dmof_export_wrap">
												...
												<textarea><?php echo $json_data = base64_encode(serialize(dmof_theme_options())); ?></textarea>
											</div>
